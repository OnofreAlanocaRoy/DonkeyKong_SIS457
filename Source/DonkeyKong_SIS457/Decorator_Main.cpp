...
//#include "Kismet/KismetMathLibrary.h" // Para rotaciones y otras utilidades
//
...
//        FVector SpawnLocation = FVector(2190.0f, -590.0f, 240.0f); // Posición fija
//        FRotator SpawnRotation = FRotator::ZeroRotator;
//
//        // Validar GetWorld()
//        if (!GetWorld())
//        {
//            UE_LOG(LogTemp, Error, TEXT("El mundo no está disponible para generar enemigos."));
//            continue;
//        }
//
